...
namespace ReactiveUI.WinForms {
    ...
    public interface IRecoveryCommand : IReactiveCommand {
        ...
        /// command should set the recovery result to indicate the action
        /// the throwing code should take.
        /// </summary>
    ...
    public class UserError : ReactiveObject {
        public UserError(string errorMessage, string errorCauseOrResolution = null,
        ...
        [ThreadStatic]
        static Func<UserError, IObservable<RecoveryOptionResult>> overridenRegisteredUserErrorHandlers;
        ...
        /// deal with") - this method is the simples way to prompt the user
        ...
        /// <returns>An Observable representig the action the code should
        /// attempt to take.</returns>
        ...
        public static IObservable<RecoveryOptionResult> Throw(UserError error) {
            var handlers = (overridenRegisteredUserErrorHandlers != null) ?
                new[] { overridenRegisteredUserErrorHandlers } :
        ...
        /// usually by representig it to the user. If the handler cannot handle
        ...
        /// </summary>
        /// <param name="errorHandler">A method that can handle a UserError,
        /// usually by representing it to the user. If the handler cannot handle
        /// the error, it should return null.</param>
        /// <returns>An IDisposable which will unregister the handler.</returns>
        ...
        /// its filter.
        /// </summary>
        /// <param name="command">The RecoverCommand to add.</param>
        ...
        public static IDisposable OverrideHandlersForTesting(Func<UserError, IObservable<RecoveryOptionResult>> errorHandler) {
            overridenRegisteredUserErrorHandlers = errorHandler;
            return Disposable.Create(() => overridenRegisteredUserErrorHandlers = null);
        }
    ...
    public class UnhandledUserErrorException : Exception {
        public UnhandledUserErrorException(UserError error)
            : base(error.ErrorMessage, error.InnerException) {
            ReportedError = error;
        }
    ...
    public class RecoveryCommand : ReactiveCommand, IRecoveryCommand {
        ...
        public static IRecoveryCommand Ok {
            get {
                var ret = new RecoveryCommand("Ok") { IsDefault = true };
        ...
        public static IRecoveryCommand Cancel {
            get {
                var ret = new RecoveryCommand("Cancel") { IsCancel = true };
                ret.Subscribe(_ => ret.RecoveryResult = RecoveryOptionResult.FailOperation);
                return ret;
            }
        }
        ...
        public static IRecoveryCommand Yes {
            get { 
                var ret = new RecoveryCommand("Yes") { IsDefault = true };
                ret.Subscribe(_ => ret.RecoveryResult = RecoveryOptionResult.RetryOperation);
                return ret;
            }
        }
        ...
        public static IRecoveryCommand No {
            get {
                var ret = new RecoveryCommand("No") { IsCancel = true };
                ret.Subscribe(_ => ret.RecoveryResult = RecoveryOptionResult.FailOperation);
                return ret;
            }
        }
